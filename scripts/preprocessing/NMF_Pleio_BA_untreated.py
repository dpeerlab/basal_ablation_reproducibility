...
adata = sc.read_h5ad('BA_mingle_preproc_untreated_20260514.h5ad')      ##TO DO: set this to the adata that you want to read from 
...
local_corr_unclipped = pd.read_csv('BA_mingle_preproc_20260227_downsampled_allCT_v2_hotspot_local_correlations.csv', index_col=0) ##TO DO: set this to path of the local correlation matrix from hotspot
...
adata_path = Path(output_folder) / f"BA_mingle_preproc_untreated_20260514_a{alpha}_m{module_number}.h5ad"         ##TO DO: set this to the path of the adata that you want to write to (save umaps, neighbors, etc)
...
# write out
adata.write('mingle_adata/BA_mingle_preproc_untreated_20260514.h5ad')
